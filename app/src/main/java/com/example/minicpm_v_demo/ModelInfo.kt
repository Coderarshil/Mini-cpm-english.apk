    ...
    companion object {
        val AVAILABLE_MODELS = listOf(
            ModelInfo(
                ...
                description = "Lightweight multimodal model, supports image-text understanding (4.1B)",
            ...
            ModelInfo(
                ...
                description = "Next-generation multimodal model, supports image-text understanding (1.2B)",
